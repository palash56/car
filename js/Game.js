class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      ...
      { x: width / 2 + 400, y: height - 1800, image: obstacle1Image },
      { x: width / 2 - 340, y: height - 2300, image: obstacle1Image },
     
      { x: width / 2 - 550, y: height - 4700, image: obstacle1Image },
      { x: width / 2, y: height - 3900, image: obstacle1Image },
